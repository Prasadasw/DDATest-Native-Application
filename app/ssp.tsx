...
const SSPScreen = () => {
  ...
  const [selectedCourse, setSelectedCourse] = useState<SSPCourse | null>(null);
  ...
  const sspCourses: SSPCourse[] = [
    {
      ...
      price: "₹1,999",
      level: "Intermediate",
      description: "Complete interview preparation for Sainik School entrance"
    },
    {
      id: '2',
      title: "SSP Physical Training",
      instructor: "Capt. M. Kumar",
      rating: 4.8,
      students: 654,
      duration: "6 hours",
      price: "₹1,499",
      level: "Beginner",
      description: "Physical fitness and training for SSP selection"
    },
    {
      id: '3',
      title: "SSP Academic Excellence",
      ...
      price: "₹2,499",
      level: "All Levels",
      description: "Comprehensive academic preparation for SSP"
    },
    {
      id: '4',
      title: "SSP Personality Development",
      ...
      price: "₹999",
      level: "Beginner",
      description: "Personality development and leadership skills"
    },
  ];

  const renderCourseCard = ({ item }: { item: SSPCourse }) => (
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.headerContent}>
          <Text style={styles.headerTitle}>SSP Courses</Text>
          <Text style={styles.headerSubtitle}>Sainik School Preparation</Text>
        </View>
